...
@objc class YYEnvChangeViewController: BSRootVC {
    ...
    private static let envData = [
        EnvType.dev  : ["title" : "开发环境", "api" : "https://test-app.xstudyedu.com",  "h5" : "https://test-app.xstudyedu.com"],
        EnvType.test : ["title" : "测试环境", "api" : "http://nnyc-api-test.xstudyedu.com", "h5" : "https://test-app.xstudyedu.com"],
