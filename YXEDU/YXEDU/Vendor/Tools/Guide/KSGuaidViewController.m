...
- (__kindof UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 2) {
        ...
        cell.buttonStartBack.hidden = NO;
        [cell.buttonStart addTarget:self action:@selector(startHome) forControlEvents:UIControlEventTouchUpInside];
    }
    return cell;
}
- (void)startHome{
    [_collectionView setContentOffset:CGPointMake(SCREEN_WIDTH*3, 0) animated:YES];
//    [self hide];
}
