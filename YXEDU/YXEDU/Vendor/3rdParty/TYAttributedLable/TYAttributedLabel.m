...
NSString *const kTYTextClickRunAttributedName = @"TYTextClickRunAttributedName";
NSString *const kTYTextLongPressRunAttributedName = @"TYTextLongpressRunAttributedName";
...
- (void)longPress:(UILongPressGestureRecognizer *)sender
{
    CGPoint point = [sender locationInView:self];
    //用户展示pop view用
    CGPoint kPoint = [sender locationInView:[UIApplication sharedApplication].keyWindow.maskView];
...
- (void)appendSentenceWithText:(NSString *)wordText
{
    [_textContainer appendWordWithText: wordText];
    [self setNeedsDisplay];
}
