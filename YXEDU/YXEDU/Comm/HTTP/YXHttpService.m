...
- (void)DOWNLOAD:(NSString *)URLString
    ...
    self.downloadTask = [[YXNetworkService shared]download:URLString parameters:nil headers:nil dstFilePath:dstFilePath downloadProgress:^(NSProgress *downloadProgress) {
