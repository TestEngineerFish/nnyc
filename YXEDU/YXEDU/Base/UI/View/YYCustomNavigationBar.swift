...
//            button.frame = CGRect(x: ScreenWidth - 42, y: 0, width: 40, height: 40)
            button.titleLabel?.font = UIFont.iconfont(size: 26)
        }
    ...
    @objc public lazy var backIconLabel: UILabel = {
        ...
        label.text = kIconFont_back
        label.font = UIFont.iconfont(size: 28)
...
extension YYCustomNavigationBar {
    ...
    private func createSubviews() {
        ...
        let height: CGFloat = isLargeTitle ? 44 : 44
