...
//    if ([statusBar isKindOfClass:NSClassFromString(@"UIStatusBar_Modern")]) { // iphoneX serious
//        id statusBarView = [statusBar valueForKeyPath:@"statusBar"];
//        UIView *foregroundView = [statusBarView valueForKeyPath:@"foregroundView"];
//        NSArray *subviews = [[foregroundView subviews][2] subviews];// [foregroundView subviews];//
//
