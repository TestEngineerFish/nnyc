...
- (UIView *)selectView {
    if (!_selectView) {
        ...
        if (iPhone4) {
            ...
            _selectView.frame = CGRectMake(0, SCREEN_HEIGHT-SafeBottomMargin-SCREEN_WIDTH-40, SCREEN_WIDTH, SCREEN_WIDTH-40);
        } else {
            _selectView.frame = CGRectMake(0, SCREEN_HEIGHT-SafeBottomMargin-SCREEN_WIDTH-40-NavHeight, SCREEN_WIDTH, SCREEN_WIDTH-40);
        }
