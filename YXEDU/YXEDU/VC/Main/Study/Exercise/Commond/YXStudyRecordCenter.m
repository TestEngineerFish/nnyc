...
- (void)insertRecord:(YXStudyRecordModel *)model completeBlock:(finishBlock)block {
    ...
    [[YXFMDBManager shared]replaceRecord:model
...
- (void)queryRecord:(finishBlock)block {
    [[YXFMDBManager shared]queryRecord:^(id obj, BOOL result) {
        block(obj, result);
    }];
}

- (void)queryRecordByRecordId:(NSString *)recordId completeBlock:(finishBlock)block {
    [[YXFMDBManager shared]queryRecordByRecordId:recordId
                                   completeBlock:^(id obj, BOOL result) {
        block(obj, result);
    }];
}
...
- (void)deleteRow:(YXStudyRecordModel *)model completeBlock:(finishBlock)block {
    [[YXFMDBManager shared]deleteRecordRow:model completeBlock:^(id obj, BOOL result) {
        block(obj, result);
    }];
}

- (void)deleteAll:(finishBlock)block  {
    [[YXFMDBManager shared]deleteRecordAll:^(id obj, BOOL result) {
        block(obj, result);
    }];
}
...
- (void)batchDelete:(NSMutableArray *)recordArr completeBlock:(finishBlock)block {
    ...
    [[YXFMDBManager shared]batchDeleteRecord:recordArr completeBlock:^(id obj, BOOL result) {
        block(obj, result);
    }];
}
