...
- (void)viewDidLoad {
    ...
    self.titleImageView = [[UIImageView alloc]initWithFrame:CGRectMake((SCREEN_WIDTH-200)/2.0f, NavHeight + 28, 200, 178)];
    self.titleImageView.image = [UIImage imageNamed:@"study_unit_titleimage"];
    [self.view addSubview:self.titleImageView];
    
    self.startLab = [[UILabel alloc]initWithFrame:CGRectMake(0, 92+NavHeight, SCREEN_WIDTH, 20)];
    ...
    self.bottomView = [[UIView alloc]initWithFrame:CGRectMake(0, NavHeight + 260, SCREEN_WIDTH, SCREEN_HEIGHT-NavHeight-260)];
