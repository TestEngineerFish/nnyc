...
- (UILabel *)studyTitleLab {
    if (!_studyTitleLab) {
        ...
        if (iPhone4) {
            _studyTitleLab.frame = CGRectMake(0, 300-kNavHeight, SCREEN_WIDTH, 20);
        } else if (iPhone5) {
...
- (UILabel *)studyNumLab {
    if (!_studyNumLab) {
        ...
        if (iPhone4) {
            _studyNumLab.frame = CGRectMake(0, 321-kNavHeight, SCREEN_WIDTH, 36);
        } else if (iPhone5) {
...
- (UIButton *)enterNextBtn {
    if (!_enterNextBtn) {
        ...
        if (iPhone4) {
            _enterNextBtn.frame = CGRectMake((SCREEN_WIDTH-200)/2.0, 370-kNavHeight, 200, 54);
        } else if (iPhone5) {
...
- (UIButton *)reCallingBtn {
    if (!_reCallingBtn) {
        ...
        if (iPhone4) {
            _reCallingBtn.frame = CGRectMake((SCREEN_WIDTH-200)/2.0, 438-kNavHeight, 200, 54);
        } else if (iPhone5) {
