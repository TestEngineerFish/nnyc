 ...
 *  Y轴刻度标签 与 Y轴 之间 空隙
 */
#define HORIZON_YMARKLAB_YAXISLINE 12.f

/**
 *  Y轴刻度标签  宽度
 */
#define YMARKLAB_WIDTH 5.f
...
//    [xAxisLayer setLineDashPattern:[NSArray arrayWithObjects:[NSNumber numberWithInt:1], [NSNumber numberWithInt:1.5], nil]];
    ...
    xAxisLayer.strokeColor = [UIColor colorWithRed:167/255.0 green:199/255.0 blue:226/255.0 alpha:0.8].CGColor;
