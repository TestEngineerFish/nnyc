...
enum YXExerciseType {
    ...
    //MARK: ---- 判断题
    case judgeWordAndChineseChooseRight      // 判断单词和词义对错
    case judgeImageAndWordChooseRight        // 判断图片和单词对错
    ...
    //MARK: ---- 填空题
    case fillWordWithChineseAttachment                // 看中文填空（附加中文，仅点击）
    case fillWordWithListenAttachment                 // 听录音填空（附加听录音，仅点击）
    case fillWordWithImageAttachment                  // 看图片填空（附加图片，仅点击）
    
    case fillWordWithChinese                // 看中文填空（点击or连线）
